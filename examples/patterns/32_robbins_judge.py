"""Starter demo for pattern #32 — Robbins-Judge 7-Culture.

Profile a fleet across the seven culture dimensions.
...
Usage:
    ...
    python examples/patterns/32_robbins_judge.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for robbins_culture",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-robbins_culture*/WALKTHROUGH.md")
    print()
