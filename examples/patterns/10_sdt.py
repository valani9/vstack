"""Starter demo for pattern #10 — SDT Intrinsic Reward Audit.

Score autonomy / competence / relatedness for long-horizon engagement.
...
Usage:
    ...
    python examples/patterns/10_sdt.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for sdt_reward",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-sdt_reward*/WALKTHROUGH.md")
    print()
