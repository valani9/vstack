"""Starter demo for pattern #12 — Vroom Expectancy Theory.

Decompose motivation into Expectancy x Instrumentality x Valence.
...
Usage:
    ...
    python examples/patterns/12_vroom.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for vroom_expectancy",
        "evidence": [
...
def _print_report(report) -> None:
    ...
    print("Pattern: vroom_expectancy")
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-vroom_expectancy*/WALKTHROUGH.md")
    print()
