"""Starter demo for pattern #24 — SMART Goal Generator.

Rewrite vague agent goals into SMART form (Specific/Measurable/etc).
...
Usage:
    ...
    python examples/patterns/24_smart_goal.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for smart_goal",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-smart_goal*/WALKTHROUGH.md")
    print()
