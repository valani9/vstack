"""Starter demo for pattern #33 — Org Structure Matrix.

Match the fleet's structure (Functional/Divisional/Matrix/Network/Holacratic) to task.
...
Usage:
    ...
    python examples/patterns/33_org_structure.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for org_structure",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-org_structure*/WALKTHROUGH.md")
    print()
