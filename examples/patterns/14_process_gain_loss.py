"""Starter demo for pattern #14 — Process Gain/Loss.

Measure whether the team produces more than the sum of solo agents.
...
Usage:
    ...
    python examples/patterns/14_process_gain_loss.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for process_gain_loss",
        "evidence": [
...
def _print_report(report) -> None:
    ...
    print("Pattern: process_gain_loss")
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-process_gain_loss*/WALKTHROUGH.md")
    print()
