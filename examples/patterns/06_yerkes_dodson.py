"""Starter demo for pattern #06 — Yerkes-Dodson Workload.

Place the agent on the inverted-U arousal-performance curve.
...
Usage:
    ...
    python examples/patterns/06_yerkes_dodson.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for yerkes_dodson",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-yerkes_dodson*/WALKTHROUGH.md")
    print()
