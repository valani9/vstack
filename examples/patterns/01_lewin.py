"""Starter demo for pattern #01 — Lewin Attribution Diagnostic.

Decompose an agent failure into internal (model) vs environmental (scaffolding) locus.
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for lewin",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-lewin*/WALKTHROUGH.md")
    print()
