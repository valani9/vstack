"""Starter demo for pattern #17 — Lencioni 5 Dysfunctions.

Find the lowest broken dysfunction on the pyramid (Trust through Results).
...
Usage:
    ...
    python examples/patterns/17_lencioni.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for lencioni",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-lencioni*/WALKTHROUGH.md")
    print()
