"""Starter demo for pattern #08 — Grant Strengths-as-Weaknesses.

Detect when an agent's strength (helpfulness, thoroughness) becomes a liability.
...
Usage:
    ...
    python examples/patterns/08_grant.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for grant_strengths",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-grant_strengths*/WALKTHROUGH.md")
    print()
