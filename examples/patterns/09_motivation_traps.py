"""Starter demo for pattern #09 — Motivation Traps.

Surface reward-hacking traps (length / citation / tool / politeness).
...
Usage:
    ...
    python examples/patterns/09_motivation_traps.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for motivation_traps",
        "evidence": [
...
def _print_report(report) -> None:
    ...
    print("Pattern: motivation_traps")
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-motivation_traps*/WALKTHROUGH.md")
    print()
