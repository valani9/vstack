"""Starter demo for pattern #22 — Stone-Heen Feedback Triggers.

Detect which trigger (Truth / Relationship / Identity) fired on a feedback episode.
...
Usage:
    ...
    python examples/patterns/22_stone_heen.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for feedback_triggers",
        "evidence": [
...
def _print_report(report) -> None:
    ...
    print("Pattern: feedback_triggers")
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-feedback_triggers*/WALKTHROUGH.md")
    print()
