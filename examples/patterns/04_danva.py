"""Starter demo for pattern #04 — DANVA Emotion Reader.

Measure agent accuracy at reading user emotional state from short cues.
...
Usage:
    ...
    python examples/patterns/04_danva.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for danva_emotion",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-danva_emotion*/WALKTHROUGH.md")
    print()
