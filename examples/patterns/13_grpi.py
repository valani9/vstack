"""Starter demo for pattern #13 — GRPI Working Agreement.

Identify which of Goals / Roles / Processes / Interpersonal layer broke.
...
Usage:
    ...
    python examples/patterns/13_grpi.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for grpi",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-grpi*/WALKTHROUGH.md")
    print()
