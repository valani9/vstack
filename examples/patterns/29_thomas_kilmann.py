"""Starter demo for pattern #29 — Thomas-Kilmann Conflict Mode.

Pick or audit conflict-handling mode (Competing/Collaborating/etc).
...
Usage:
    ...
    python examples/patterns/29_thomas_kilmann.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for thomas_kilmann",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-thomas_kilmann*/WALKTHROUGH.md")
    print()
