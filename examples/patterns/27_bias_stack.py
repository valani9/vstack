"""Starter demo for pattern #27 — Bias Stack Detector.

Surface 2-4 compounding cognitive biases driving the decision.
...
Usage:
    ...
    python examples/patterns/27_bias_stack.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for bias_stack",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-bias_stack*/WALKTHROUGH.md")
    print()
