"""Starter demo for pattern #02 — Goleman 4-Domain EI Audit.

Score an interaction across the four Goleman emotional-intelligence domains.
...
Usage:
    ...
    python examples/patterns/02_goleman_ei.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for goleman_ei",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-goleman_ei*/WALKTHROUGH.md")
    print()
