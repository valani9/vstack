"""Starter demo for pattern #19 — McAllister Trust Dimensions.

Decompose trust into cognition-based and affect-based components.
...
Usage:
    ...
    python examples/patterns/19_mcallister.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for mcallister_trust",
        "evidence": [
...
def _print_report(report) -> None:
    ...
    print("Pattern: mcallister_trust")
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-mcallister_trust*/WALKTHROUGH.md")
    print()
