"""Starter demo for pattern #30 — After-Action Review Generator.

Produce a structured 4-question retro from a task trace.
...
Usage:
    ...
    python examples/patterns/30_aar.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for aar",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-aar*/WALKTHROUGH.md")
    print()
