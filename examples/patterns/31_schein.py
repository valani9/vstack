"""Starter demo for pattern #31 — Schein Iceberg Culture.

Surface artefact / value / assumption layers of fleet culture.
...
Usage:
    ...
    python examples/patterns/31_schein.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for schein_culture",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-schein_culture*/WALKTHROUGH.md")
    print()
