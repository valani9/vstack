"""Starter demo for pattern #34 — Span of Control.

Size the right number of sub-agents per orchestrator.
...
Usage:
    ...
    python examples/patterns/34_span_of_control.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for span_of_control",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-span_of_control*/WALKTHROUGH.md")
    print()
