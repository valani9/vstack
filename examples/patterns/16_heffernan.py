"""Starter demo for pattern #16 — Heffernan Superflocks.

Identify homogeneity / conformity / status / speed dynamics in the team.
...
Usage:
    ...
    python examples/patterns/16_heffernan.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for superflocks",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-superflocks*/WALKTHROUGH.md")
    print()
