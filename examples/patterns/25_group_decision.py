"""Starter demo for pattern #25 — Group Decision Models.

Match decision type to the right Vroom-Yetton-Jago style (AI/AII/CI/CII/GII).
...
Usage:
    ...
    python examples/patterns/25_group_decision.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for group_decision",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-group_decision*/WALKTHROUGH.md")
    print()
