"""Starter demo for pattern #18 — Trust Triangle Audit.

Identify which leg of trust (Authenticity / Logic / Empathy) broke.
...
Usage:
    ...
    python examples/patterns/18_trust_triangle.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for trust_triangle",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-trust_triangle*/WALKTHROUGH.md")
    print()
