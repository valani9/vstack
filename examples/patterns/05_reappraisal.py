"""Starter demo for pattern #05 — Cognitive Reappraisal.

Classify the agent's regulatory strategy (suppression / escalation / reappraisal).
...
Usage:
    ...
    python examples/patterns/05_reappraisal.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for cognitive_reappraisal",
        "evidence": [
...
def _print_report(report) -> None:
    ...
    print("Pattern: cognitive_reappraisal")
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-cognitive_reappraisal*/WALKTHROUGH.md")
    print()
    ...
    print("       vstack-cognitive-reappraisal --help")


def main() -> None:
    """Build the trace, run diagnose() with this single pattern, print."""
    trace = stuck_in_loop_trace()
    print("=== Pattern starter demo: cognitive_reappraisal ===")
    ...
    report = diagnose(
        trace=trace,
        llm_client=_stub(),
        patterns=["cognitive_reappraisal"],
    )
