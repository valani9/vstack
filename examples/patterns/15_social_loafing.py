"""Starter demo for pattern #15 — Social Loafing Detector.

Detect an agent coasting on a team relative to its solo baseline.
...
Usage:
    ...
    python examples/patterns/15_social_loafing.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for social_loafing",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-social_loafing*/WALKTHROUGH.md")
    print()
