"""Starter demo for pattern #11 — McGregor Orchestrator Mode.

Detect Theory-X (over-verification) vs Theory-Y (blind trust) orchestrator pathology.
...
Usage:
    ...
    python examples/patterns/11_mcgregor.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for mcgregor",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-mcgregor*/WALKTHROUGH.md")
    print()
