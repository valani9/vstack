"""Starter demo for pattern #26 — Group Pathology.

Detect groupthink / polarization / behavioural contagion in the team.
...
Usage:
    ...
    python examples/patterns/26_group_pathology.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for debate_pathology",
        "evidence": [
...
def _print_report(report) -> None:
    ...
    print("Pattern: debate_pathology")
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-debate_pathology*/WALKTHROUGH.md")
    print()
