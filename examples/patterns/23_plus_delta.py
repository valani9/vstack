"""Starter demo for pattern #23 — Plus-Delta Feedback Format.

Audit feedback structure against the Plus-Delta gold standard.
...
Usage:
    ...
    python examples/patterns/23_plus_delta.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for plus_delta",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-plus_delta*/WALKTHROUGH.md")
    print()
