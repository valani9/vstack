"""Starter demo for pattern #20 — Edmondson Psych Safety.

Measure the four learning behaviours (help / feedback / challenge / admit).
...
Usage:
    ...
    python examples/patterns/20_edmondson.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for psych_safety",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-psych_safety*/WALKTHROUGH.md")
    print()
