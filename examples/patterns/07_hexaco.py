"""Starter demo for pattern #07 — HEXACO Personality Profiler.

Profile the agent across six stable behavioural dimensions (H/E/X/A/C/O).
...
Usage:
    ...
    python examples/patterns/07_hexaco.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for hexaco",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-hexaco*/WALKTHROUGH.md")
    print()
