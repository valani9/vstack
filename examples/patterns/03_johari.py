"""Starter demo for pattern #03 — Johari Window for Agents.

Map agent self-knowledge into ARENA / BLIND-SPOT / FACADE / UNKNOWN quadrants.
...
Usage:
    ...
    python examples/patterns/03_johari.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for johari",
        "evidence": [
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-johari*/WALKTHROUGH.md")
    print()
