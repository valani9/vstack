"""Starter demo for pattern #21 — Glaser Conversational Intelligence.

Identify which conversational level (I/II/III) the conversation is on.
...
Usage:
    ...
    python examples/patterns/21_glaser.py
"""
...
def _stub() -> StubClient:
    ...
    finding = {
        "severity": "medium",
        "title": "Starter-demo stub finding for glaser_conversation",
        "evidence": [
...
def _print_report(report) -> None:
    ...
    print("Pattern: glaser_conversation")
...
def _print_next_steps() -> None:
    ...
    print("     module-*-*/NN-glaser_conversation*/WALKTHROUGH.md")
    print()
